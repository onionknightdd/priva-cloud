...
_SYSTEM_PROMPT = (
    ...
    "Choose the recap language from user input only. Use the language of the "
    "latest substantive user message in the digest. Do not infer the language "
    "from assistant messages, tool output, code, file paths, or quoted content.\n"
